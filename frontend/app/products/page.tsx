...
function ProductCard({
  ...
  const priority = index < 4; // Priority load first 4 on mobile grid

  const fixedDiscount = getDiscountPercentage(
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square w-full overflow-hidden bg-[#F5F4F0]">
        <ProductImage src={image} alt={product.name} priority={priority} />
      ...
      <div className="p-3.5 sm:p-5">
        ...
        <h2 className="mt-1.5 line-clamp-2 min-h-[36px] text-[13px] font-bold leading-5 tracking-[-0.01em] text-[#0A1B2E] transition-colors duration-200 group-hover:text-[#B9954F] sm:min-h-[40px] sm:text-[15px]">
          {product.name}
        </h2>
            ...
            {variantPrice ? (
              <span className="block truncate text-sm font-extrabold tracking-[-0.01em] text-[#0A1B2E] sm:text-base">
                {variantPrice.hasRange
                  ? `From ${formatPrice(variantPrice.minPrice)}`
                  : formatPrice(variantPrice.minPrice)}
              </span>
...
export default function ProductsPage() {
  ...
  const categories = useMemo(() => {
    ...
    for (const product of products) {
      ...
      const key = category._id || category.slug || category.name;
  ...
  if (error && !loading) {
    return (
      <>
        <Navbar />
        <main
          className="min-h-[100svh] px-4 pb-20 pt-[86px] sm:px-6 sm:pt-[105px]"
          style={{
          ...
          <div className="mx-auto flex min-h-[70svh] w-full max-w-md items-center justify-center">
            <div className="w-full rounded-[12px] border border-[#E5E7EB] bg-white p-7 text-center shadow-[0_8px_30px_-20px_rgba(10,27,46,0.25)] sm:p-10">
              ...
              <p className="mt-2 text-sm leading-6 text-[#64748B]">
                We couldn't retrieve the products right now. Please try again.
              </p>
              <button
                type="button"
  ...
  return (
    <>
      ...
      <main
        className="min-h-[100svh] overflow-x-hidden pb-20 pt-[76px] sm:pt-[92px] lg:pt-[100px]"
        style={{
          backgroundImage: 'url("/image_f4dd83.png")',
          backgroundSize: "cover",
          backgroundPosition: "top center",
      ...
      >
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section className="pb-6 pt-5 sm:pb-9 sm:pt-7 lg:pb-10">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 max-w-xl text-[13px] leading-6 text-[#64748B] sm:text-sm sm:leading-7 lg:text-base">
                Explore our collection of custom printing products for teams,
          ...
          <section className="mb-6 rounded-[12px] border border-[#E5E7EB] bg-white p-3 shadow-[0_4px_18px_-15px_rgba(10,27,46,0.25)] sm:mb-7 sm:p-4">
            ...
            {/* MOBILE CATEGORY CHIPS WITH SMOOTH SCROLL */}
            {categories.length > 0 && (
              <div
                className="
                  mt-3
          ...
          {loading && (
            ...
            >
              {Array.from({ length: INITIAL_VISIBLE_SKELETONS }).map(
                (_, index) => (
