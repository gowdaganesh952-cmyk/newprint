...
export default function CategoryDeleteDialog({ category, onConfirm, onCancel, loading }: CategoryDeleteDialogProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="fixed inset-0 bg-[#0A1B2E]/60 backdrop-blur-sm" onClick={!loading ? onCancel : undefined} />
      <div className="relative w-full max-w-sm overflow-hidden rounded-[12px] bg-white p-6 shadow-xl text-center">
        <h3 className="text-lg font-bold text-[#0A1B2E]">Delete Category</h3>
