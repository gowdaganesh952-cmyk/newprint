  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <rect x="72" y="75" width="64" height="46" rx="5" fill="#F7F7F5" />
      <path
        d="M87 98h34"
        stroke="#B9954F"
        strokeWidth="4"
...
function FrameIcon() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M48 35h84v84H48z" fill="#B9954F" opacity=".18" />
      <rect x="43" y="30" width="94" height="94" rx="3" fill="#0A1B2E" />
      <rect x="53" y="40" width="74" height="74" rx="2" fill="#F7F7F5" />
      <path
      ...
      />
      <circle cx="78" cy="61" r="7" fill="#B9954F" />
      <path d="M90 124v20" stroke="#0A1B2E" strokeWidth="5" />
      <path
        d="M69 144h42"
        stroke="#0A1B2E"
        strokeWidth="5"
...
function KeychainIcon() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <circle cx="90" cy="45" r="23" stroke="#0A1B2E" strokeWidth="7" />
      <path
        d="M90 68v20"
        stroke="#B9954F"
        strokeWidth="7"
        strokeLinecap="round"
      />
      <rect x="48" y="86" width="84" height="60" rx="9" fill="#0A1B2E" />
      <rect x="59" y="97" width="62" height="38" rx="4" fill="#F7F7F5" />
      <circle cx="82" cy="116" r="7" fill="#B9954F" />
      <path
        d="M94 119h17"
        stroke="#B9954F"
        strokeWidth="4"
...
export default function AboutPage() {
  const WHATSAPP_URL =
    "https://wa.me/917406925565?text=Hello%20New%20Print!%20I%20would%20like%20to%20know%20more%20about%20your%20personalised%20printing%20products.";
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl text-center">
            <div className="about-fade-in flex flex-col items-center">
              ...
              <h1 className="mt-5 max-w-4xl text-[42px] font-extrabold leading-[1.02] tracking-[-0.045em] text-white sm:text-6xl md:text-7xl lg:text-[82px]">
                Your moments.
                <br />
                <span className="text-[#D4B979]">Made to stay.</span>
              </h1>

              <p className="mx-auto mt-6 max-w-2xl text-[14px] leading-6 text-white/65 sm:text-lg sm:leading-7">
                We turn your favourite photographs, memories and ideas into
                personalised products you can wear, use, display and carry every
                day.
              </p>
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-20">
            ...
            <div className="lg:col-span-7">
              <div className="space-y-5 text-[14px] leading-7 text-[#64748B] sm:text-lg sm:leading-8">
                <p>
                  Today, so many of our favourite moments live inside our phones.
                  We scroll through them, smile, and move on.
                </p>
                <p>
                  <span className="font-bold text-[#0A1B2E]">New Print</span> is
                  about bringing those moments back into the real world.
                </p>
                <p>
                  We create personalised products from the memories that matter
                  to you — from T-shirts and mugs to rotating photo frames and
                  keychains.
                </p>
              </div>
        ...
        <section className="bg-white px-5 py-20 sm:px-8 sm:py-28">
          <div className="mx-auto w-full max-w-7xl">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-5 text-[32px] font-extrabold leading-[1.08] tracking-[-0.035em] text-[#0A1B2E] sm:text-5xl">
                Made for the moments you don't want to forget.
              </h2>
              <p className="mt-4 text-sm leading-6 text-[#64748B] sm:text-base">
                Choose a product, add your favourite memories, and create
            ...
            {/* mobile horizontal slider (GPU Accelerated + Touch Optimised) */}
            <div
              className="
                mt-10
                flex
          ...
          <div className="mx-auto w-full max-w-7xl">
            <div className="text-center">
              ...
              <h2 className="mt-5 text-[32px] font-extrabold tracking-[-0.035em] text-[#0A1B2E] sm:text-5xl">
                From your gallery
                <br className="sm:hidden" /> to something real.
              </h2>

              <p className="mx-auto mt-4 max-w-xl text-sm leading-6 text-[#64748B] sm:text-base">
                Creating something personal should be simple. That's why we keep
        ...
        <section className="bg-[#0A1B2E] px-5 py-20 text-white sm:px-8 sm:py-28">
          <div className="mx-auto w-full max-w-7xl">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center lg:gap-20">
              <div className="lg:col-span-5">
                <SectionLabel>Why New Print</SectionLabel>
                ...
                <p className="mt-5 text-sm leading-6 text-white/55 sm:text-base sm:leading-7">
                  We believe personalised products are more than things. They
                  are small reminders of people, places and moments that matter.
                </p>
              </div>
        ...
        <section className="relative overflow-hidden bg-white px-5 py-24 sm:px-8 sm:py-36">
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 text-[38px] font-extrabold leading-[1.04] tracking-[-0.045em] text-[#0A1B2E] sm:text-6xl">
              Photos are memories.
              <br />
              <span className="text-[#B9954F]">Prints make them real.</span>
            </h2>

            <p className="mx-auto mt-6 max-w-xl text-sm leading-6 text-[#64748B] sm:text-base sm:leading-7">
              Whether it is a gift, a celebration, a friendship, a family moment,
              or simply a photo you love — give it a place outside your phone.
            </p>
        ...
        <section className="bg-[#0A1B2E] px-5 py-20 sm:px-8 sm:py-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-lg text-sm leading-6 text-white/55">
              Turn a favourite photograph into something you can keep, use, gift
              and enjoy every day.
            </p>
            <Link
              href="/products"
