...
export default function AddressesPage() {
  ...
  const handleSaveAddress = async (formData: AddressFormData) => {
    ...
    try {
      ...
      window.alert("Failed to save address. Please try again.");
    } finally {
  ...
  const handleDeleteAddress = async (id: string) => {
    ...
    try {
      ...
      window.alert("Failed to delete address. Please try again.");
    } finally {
      setActionId(null);
    }
  };
  ...
  const handleSetDefault = async (id: string) => {
    ...
    try {
      ...
      window.alert("Failed to update default address. Please try again.");
    } finally {
      setActionId(null);
    }
  };
    ...
    <div className="min-w-0 space-y-5 sm:space-y-6 scroll-smooth">
      ...
      {isLoading ? (
        ...
        <div className="rounded-[14px] border border-[#E5E7EB] bg-white p-8 text-center shadow-[0_2px_12px_-8px_rgba(10,27,46,0.25)] sm:p-12">
          ...
          <h3 className="mt-4 font-bold text-[#0A1B2E]">No saved addresses</h3>
          <p className="mt-1 text-sm text-[#64748B]">
